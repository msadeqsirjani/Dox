...
public class UploadOptions
{
    ...
    [Option('n', "no-progress", Required = false, HelpText = "Suppress progress output when using chunked uploading")]
    public bool NoProgress { get; set; }

    [Option('k', "chunk-size", Required = false,
        HelpText = "Chunk size (in kilobytes) to use during chunked uploading. Defaults to 1024, minimum is 128.")]
    ...
    [Option('t', "timeout", Required = false,
        HelpText = "HTTP Timeout (in seconds) for upload operations. Defaults to 100.")]
